 ...
 * 日历过滤
 */
public class LocalDateFilterTest extends JPanel {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(LocalDateFilterTest::createAndShowGui);
	}
	...
	private static void createAndShowGui() {
		...
		frame.getContentPane().add(new LocalDateFilterTest());
		frame.pack();
