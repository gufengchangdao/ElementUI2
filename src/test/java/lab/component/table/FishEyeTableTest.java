 ...
 * 表格行大小随鼠标移动而改变
 */
public class FishEyeTableTest extends JPanel {
	private FishEyeTableTest() {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(FishEyeTableTest::createAndShowGui);
	}
	...
	private static void createAndShowGui() {
		...
		frame.getContentPane().add(new FishEyeTableTest());
		frame.pack();
