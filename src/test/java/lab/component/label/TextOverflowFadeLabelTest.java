 ...
 * 不同方式实现文本溢出时末尾淡出效果
 */
public class TextOverflowFadeLabelTest extends JPanel {
	private TextOverflowFadeLabelTest() {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			...
			p.add(new TextOverflowFadeLabelTest(), "center");
			SwingTestUtil.test();
		});
	}
}
