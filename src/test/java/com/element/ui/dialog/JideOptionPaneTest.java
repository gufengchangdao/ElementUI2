...
public class JideOptionPaneTest extends AbstractDemo {
	public JPanel _demoPanel;

	public JideOptionPaneTest() {
	}
	...
	public String getDescription() {
		return """
				JideOptionPane is an enhanced version of Swing's JOptionPane.\s

				1. Supports banner panel to get a better looking message box.\s
	...
	public JButton createComponentDialogButton() {
		Action a = new AbstractAction("Show Component Dialog") {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Options
				String[] options = {
						LocaleUtil.getYesString(_demoPanel.getLocale()),
						LocaleUtil.getNoString(_demoPanel.getLocale()),
						"Maybe",
						"Probably",
						LocaleUtil.getCancelString(_demoPanel.getLocale())
				};
