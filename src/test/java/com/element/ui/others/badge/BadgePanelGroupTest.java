...
public class BadgePanelGroupTest extends AbstractDemo {
	static BadgePanelGroup badgePanelGroup;
	@Override
	public Component getDemoPanel() throws Exception {
		...
		badgePanelGroup = new BadgePanelGroup(panel,
				Arrays.asList(b2, b3),
		...
		return badgePanelGroup.getLayeredPane();
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			...
			showAsFrame(new BadgePanelGroupTest());
