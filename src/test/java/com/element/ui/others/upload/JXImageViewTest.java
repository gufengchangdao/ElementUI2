...
/**
 * 预览图片使用，暂时还不是组件，作为未来组件的参考对象
 */
public class JXImageViewTest extends AbstractDemo {
	@Override
	public Component getDemoPanel() throws Exception {
		MyJXImageView imageView = new MyJXImageView(getFrame());
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> {
			...
			showAsFrame(new JXImageViewTest());
		});
	}
}

class MyJXImageView extends JXImageView {
	 ...
	 */
	public MyJXImageView(JFrame frame) {
		this.frame = frame;
		addListener();
	}
