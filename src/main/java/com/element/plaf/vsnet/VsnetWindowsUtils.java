...
public class VsnetWindowsUtils extends VsnetLookAndFeelExtension {
	...
	public static void initComponentDefaults(UIDefaults table) {
		...
		if ((products & PRODUCT_ACTION) != 0) {
			Object commandBarBackground = new ExtWindowsDesktopProperty(new String[]{"win.3d.backgroundColor"}, new Object[]{UIDefaultsLookup.get("control")}, toolkit, obj -> new ColorUIResource(VsnetUtils.getToolBarBackgroundColor((Color) obj[0])));
