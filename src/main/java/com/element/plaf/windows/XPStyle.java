...
import com.element.plaf.windows.TMSchema.Part;
...
public class XPStyle {
	...
	private static final SkinPainter skinPainter = new SkinPainter();

	private static Boolean themeActive = null;

	private final HashMap<String, Border> borderMap;
	private final HashMap<String, Color> colorMap;

	private final boolean flatMenus;
