...
//             _tabContainer.remove(_tabScroller.croppedEdge);
	...
	protected void uninstallKeyboardActions() {
		...
		if (_closeButtons != null) {
			Arrays.fill(_closeButtons, null);
			_closeButtons = null;
		}
	}
...
//            width += _tabRectPadding;
	...
	private static class SetSelectedIndexAction extends AbstractAction {
		public void actionPerformed(ActionEvent e) {
			...
			if (pane != null && (pane.getUI() instanceof BasicJideTabbedPaneUI ui)) {
...
//                calculatedBaseline = false;
	...
	public class TabSelectionHandler implements ChangeListener {
		public void stateChanged(ChangeEvent e) {
			...
			ensureCloseButtonCreated();
			Runnable runnable = () -> ensureActiveTabIsVisible(false);
	...
	public static class MouseMotionHandler extends MouseMotionAdapter {
...
*/
	...
	protected TabEditor createDefaultTabEditor() {
		...
		editor.addActionListener(e -> editor.transferFocus());
...
//        getTabPanel().doLayout();
	...
	protected static class TabEditor extends JTextField implements UIResource {
		TabEditor() {
			setOpaque(false);
//            setBorder(BorderFactory.createEmptyBorder());
