...
public class Base64 {
	...
	public static boolean decodeToFile(String dataToDecode, String filename) {
		boolean success;
		try (OutputStream bos = new OutputStream(new FileOutputStream(filename), Base64.DECODE)) {
	...
	public static byte[] decodeFromFile(String filename) {
		...
		try(InputStream bis  = new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64.DECODE)) {
			byte[] buffer;
			int length = 0;
			int numBytes;
	...
	public static String encodeFromFile(String filename) {
		...
		// Set up some useful variables
		java.io.File file = new java.io.File(filename);
		try(InputStream bis = new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64.ENCODE)) {
