...
//
// import com.element.range.BigDecimalRange;
...
//
// /**
//  * 与 BigDecimal 相关的几个实用方法的集合。
//  * 我们只在 JIDE Pivot Grid 中的 BigDecimalSummaryCalculator 中使用了它。但此类将保留为与 BigDecimal 相关的方法的占位符。
//  */
// public final class BigDecimalMathUtils {
// 	public static final BigDecimal TWO = BigDecimal.valueOf(2);
//
// 	private BigDecimalMathUtils() {
// 	}
//
// 	/**
...
// 		TreeSet<BigDecimal> decimals = new TreeSet<>(numbers);
