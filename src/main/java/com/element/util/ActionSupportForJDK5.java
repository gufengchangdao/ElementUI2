...
// 		}
//
// 		PropertyChangeListener listener = e -> ActionSupportForJDK5.actionPropertyChanged(button, action, e.getPropertyName());
// 		action.addPropertyChangeListener(listener);
// 		ItemListener itemListener = e -> setActionSelected(action, e.getStateChange() == ItemEvent.SELECTED);
