...
public abstract class SwingWorker<T, V> implements Future<T>, Runnable {
			...
			ThreadFactory threadFactory =
					new ThreadFactory() {
						...
						public Thread newThread(final Runnable r) {
							String name = "SwingWorker-pool-" + System.identityHashCode(this) + "-thread-" + threadNumber.getAndIncrement();
	...
	private static class SwingWorkerPropertyChangeSupport
