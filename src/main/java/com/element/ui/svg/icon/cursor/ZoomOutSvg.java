...
public class ZoomOutSvg extends AbstractSvgIcon {
	/**
...
// _0_0_2
		...
		generalPath.moveTo(13.0f, 8.02f);
		generalPath.lineTo(7.02f, 8.02f);
		generalPath.lineTo(7.02f, 10.0f);
		generalPath.lineTo(13.0f, 10.0f);
		generalPath.lineTo(13.0f, 8.02f);
		generalPath.closePath();
		shape = generalPath;
		paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
		g.setPaint(paint);
	...
	public static SvgIcon of(int width, int height) {
		ZoomOutSvg base = new ZoomOutSvg();
		base.width = width;
		base.height = height;
		return base;
	}
