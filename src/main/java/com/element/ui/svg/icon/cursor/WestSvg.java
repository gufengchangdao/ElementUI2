...
public class WestSvg extends AbstractSvgIcon {
	/**
...
// _0_0_1
		...
		generalPath.lineTo(10.0f, 15.59f);
		generalPath.lineTo(6.41f, 12.0f);
		generalPath.lineTo(10.0f, 8.42001f);
