...
public class ProhibitSvg extends AbstractSvgIcon {
	/**
...
// _0_1
		...
		generalPath.moveTo(7.51245f, 7.51251f);
		generalPath.lineTo(24.4874f, 24.4875f);
		shape = generalPath;
		g.setPaint(paint);
		g.setStroke(stroke);
		g.draw(shape);
	...
	public static SvgIcon of(int width, int height) {
		ProhibitSvg base = new ProhibitSvg();
		base.width = width;
		base.height = height;
		return base;
	}
