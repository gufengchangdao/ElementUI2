...
//            tabLayoutPolicy = SCROLL_TAB_LAYOUT;
	...
	public void setComponentAt(int index, Component c) {
		...
		boolean contains = _closableSet.contains(oldComponent);
...
//        fireStateChanged();
	...
	protected static class PageLastFocusTracker extends JideFocusTracker {
...
//        }
	 ...
	 * instead of {@link #setBackgroundAt(int, Color)} method is because this way queries the color. So it can
