 ...
 */
class RemoveButtonMouseListener extends MouseAdapter {
	@Override
	public void mouseMoved(MouseEvent e) {
		...
		RemoveCellRenderer<?> renderer = (RemoveCellRenderer<?>) list.getCellRenderer();
	...
	public void mouseReleased(MouseEvent e) {
		...
		((RemoveCellRenderer<?>) list.getCellRenderer()).rolloverIndex = -1;
		list.repaint(); // repaint all cells
	}
