...
/**
 * 设置编辑器的方式为 JComboBox 的输入框添加占位符。使用方法：
 * <pre>
 *  PlaceholderComboBoxEditor c = new PlaceholderComboBoxEditor("提示文本");
 * 	comboBox.setEditor(c);
 * </pre>
 * <p>
 * 也可以使用OverlayComboBox和JLabel实现相同的功能，后者也更加灵活。具体参考 PlaceholderComboBoxEditorTest
 */
...
class PlaceholderLayerUI<E extends JTextComponent> extends LayerUI<E> {
	private static final Color INACTIVE = ColorUtil.PLACEHOLDER_TEXT;
