 ...
 * text field background for mismatch by using {@link #setMismatchForeground(Color)}.
 * <p/>
 */
public class SearchableBar extends JToolBar implements SearchableProvider {
	...
	public SearchableBar(Searchable searchable, String initialText, boolean compact) {
		...
		_searchable.addSearchableListener(e -> {
	...
	public String[] getSearchHistory() {
		return _searchHistory == null ? new String[0] : _searchHistory.toArray(new String[0]);
	}
	...
	private void showMessage(String message) {
		...
		_messagePopup = JidePopupFactory.getSharedInstance().createPopup();
