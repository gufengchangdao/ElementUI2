...
public class ButtonPanel extends JPanel implements ButtonListener, ButtonNames {
	 ...
	 * constraint parameter in {@link #addButton(AbstractButton, Object)} method.
	 */
	 ...
	 * constant is used as constraint parameter in {@link #addButton(AbstractButton, Object)} method.
	 */
	...
	/**
	 * Removes the button. It's the same as {@link #remove(Component)}.
	 *
	 * @param button a button
	 */
				...
				if (e.getButtonName().equals(component.getName())) {
					switch (e.getID()) {
						...
						case ButtonEvent.CHANGE_BUTTON_FOCUS:
							Runnable runnable = component::requestFocus;
	 ...
	 * parameter of {@link #add(Component, Object)}.
	 *
