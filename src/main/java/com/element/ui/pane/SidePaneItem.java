...
public class SidePaneItem {
	 ...
	 * Gets the foreground.
	 * <p/>
	 * If you didn't ever invoke {@link #setForeground(Color)} and the component is an instance of {@link TabColorProvider},
	 ...
	 * Gets the background.
	 * <p/>
	 * If you didn't ever invoke {@link #setBackground(Color)} and the component is an instance of {@link TabColorProvider},
