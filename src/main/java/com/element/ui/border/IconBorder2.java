 ...
 * @since 3.3.3
 */
public class IconBorder2 extends MatteBorder {
	 ...
	 */
	public IconBorder2(Icon icon, int verticalIconAlignment) {
		super(0, 0, 0, icon.getIconWidth(), icon);
	 ...
	 * @param icon         the icon
	 */
	public IconBorder2(Insets borderInsets, Icon icon) {
	 ...
	 * @param icon   the icon.
	 */
	public IconBorder2(int top, int left, int bottom, int right, Icon icon) {
