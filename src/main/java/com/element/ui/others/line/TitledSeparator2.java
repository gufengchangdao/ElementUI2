...
import com.element.ui.border.PartialGradientLineBorder;
 ...
 */
public class TitledSeparator2 extends JPanel {
	 ...
	 */
	public TitledSeparator2(String text) {
	 ...
	 */
	public TitledSeparator2(String text, int textAlignment) {
	 ...
	 *                      SwingConstants.TRAILING.
	 */
	public TitledSeparator2(String text, int type, int textAlignment) {
	 ...
	 *                       SwingConstants.TRAILING.
	 */
	public TitledSeparator2(JComponent labelComponent, int textAlignment) {
	 ...
	 *                       SwingConstants.TRAILING.
	 */
	public TitledSeparator2(JComponent labelComponent, int type, int textAlignment) {
	 ...
	 *                       SwingConstants.TRAILING.
	 */
	public TitledSeparator2(JComponent labelComponent, Border border, int textAlignment) {
	 ...
	 */
	public TitledSeparator2(JComponent labelComponent, int type, int textAlignment, int barAlignment) {
		final Border border;
	 ...
	 * @param barAlignment   Valid values are: SwingConstants.TOP, SwingConstants.CENTER or SwingConstants.BOTTOM.
	 */
	public TitledSeparator2(JComponent labelComponent, Border border, int textAlignment, int barAlignment) {
	 ...
	 *
	 * @param border Any border of type: com.element.component.basic.border.PartialEtchedBorder, com.element.component.basic.border.PartialLineBorder or
	 *               com.element.component.basic.border.PartialGradientLineBorder.
