...
import com.element.radiance.svgtranscoder.api.SvgTranscoder;
import com.element.radiance.svgtranscoder.api.TranscoderListener;
import com.element.radiance.svgtranscoder.api.java.JavaLanguageRenderer;
		...
		try {
			...
			try (PrintWriter pw = new PrintWriter(javaClassFilename);
			     ...
			     InputStream inputStream = BatchProcessFrame.class.getResourceAsStream(
					     "java/SvgTranscoderTemplateRadiance.templ")) {
