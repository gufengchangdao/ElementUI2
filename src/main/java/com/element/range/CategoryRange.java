...
public class CategoryRange<T> extends AbstractRange<T> implements Iterable<Category<T>> {
	...
	private Map<T, Integer> positionIndices = new HashMap<>();
	...
	public List<T> getPossibleValues() {
		if (sorted && !alreadySorted) {
			if (comparator == null) {
				Comparator<T> defaultComparator = (o1, o2) -> {
					if (o1 == null && o2 == null) {
						return 0;
					} else if (o1 == null) {
						return -1;
				...
				_possibleValues.sort(defaultComparator);
				positionIndices.clear();
			} else {
				_possibleValues.sort(comparator);
				positionIndices.clear();
			}
		}
	...
	public boolean equals(Object obj) {
		...
		if (maximum == null) {
			...
			return false;
		if (minimum == null) {
			return other.minimum == null;
		} else return minimum.equals(other.minimum);
	}
	...
	public String toString() {
		String builder = "#<CategoryRange " + "minimum=" + minimum + " maximum=" + maximum + ">";
		return builder;
	}
}
