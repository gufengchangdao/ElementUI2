...
import com.component.laf.AquaSliderUI;
import com.component.laf.JRSUIConstants;
...
public class AquaRangeSliderUI extends AquaSliderUI {
	...
	public void paint(Graphics g, JComponent c) {
		...
		if (clip.intersects(thumbRect)) {
			JRSUIConstants.Orientation orientation = slider.getOrientation() != 0 ? JRSUIConstants.Orientation.VERTICAL : JRSUIConstants.Orientation.HORIZONTAL;
